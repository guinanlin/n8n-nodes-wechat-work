...
import WechatWorkRequestUtils from '../../utils/wechatWorkRequestUtils';

class MessageResource implements IResource {
	name = '消息推送';
	...
	operations: ResourceOperations[] = [
		{
			...
			options: [
				...
				//*****miniprogram_notice
				{
					...
					default: '',
					description:
						'参考https://developer.work.weixin.qq.com/document/path/90236#小程序通知消息',
					type: 'json',
					displayOptions: {
						show: {
			...
			async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
				...
				let data = {
					...
					enable_duplicate_check: (this.getNodeParameter(
						'enable_duplicate_check',
						index,
					) as boolean)
						? 1
						: 0,
					duplicate_check_interval: this.getNodeParameter(
